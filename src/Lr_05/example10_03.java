...
public class example10_03 {
    ...
    static class Example {
        ...
        Example(){
            System.out.println("Конструирование объекта test Example(1)\n");
        }
        Example(int num1){
            System.out.println("Конструирование объекта Example(2) ");
            this.num1 = num1;
        ...
        Example(int num1, int num2){
            System.out.println("Конструирование объекта Example(3): ");
            this.num1 = num1;
            this.num2 = num2;
